...
class StepperOperation(ContinuousStepperOperation, SingleStepsStepperOperation, ScheduledStepsStepperOperation, ScheduledPointsStepperOperation):
    def __init__(self, number, robot_status, start_check, write):
        ...
        ContinuousStepperOperation.__init__(self, number, robot_status, start_check, write)
        SingleStepsStepperOperation.__init__(self, number, robot_status, start_check, write)
        ScheduledStepsStepperOperation.__init__(self, number, robot_status, start_check, write)
        ScheduledPointsStepperOperation.__init__(self, number, robot_status, start_check, write)
