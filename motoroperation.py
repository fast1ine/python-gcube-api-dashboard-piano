...
class MotorOperation(ContinuousMotorOperation, SingleStepsMotorOperation, ScheduledStepsMotorOperation, ScheduledPointsMotorOperation):
    def __init__(self, number, robot_status, start_check, write):
        ...
        SingleStepsMotorOperation.__init__(self, number, robot_status, start_check, write)
        ScheduledStepsMotorOperation.__init__(self, number, robot_status, start_check, write)
        ScheduledPointsMotorOperation.__init__(self, number, robot_status, start_check, write)
