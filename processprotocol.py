...
class ProcessProtocol():
    ...
    def evaluate_connection(self) -> (bool, int, bool): # is_full_connect, connected_robots_number, robot_disconnect_flag
        connection_number = self.transport._robot_status["controller_status"]["connection_number"]
        connected_robots_number = self.transport._robot_status["processed_status"]["connected_number"]
        if not self.is_full_connect and connected_robots_number == connection_number: # 모두 연결
            print("Fully connected.") 
            return True, connected_robots_number, self.robot_disconnect_flag
            ...
            if self.is_full_connect and connected_robots_number != 0: # 이전에 전부 연결되었다면 & 마스터가 끊어진 것이 아니라면
                ...
                return False, connected_robots_number, self.robot_disconnect_flag
            ...
            return self.is_full_connect, connected_robots_number, self.robot_disconnect_flag
